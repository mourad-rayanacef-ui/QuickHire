// CompanyMessages.jsx - Fixed Version with Proper Initial Message Loading
import styles from "./CompanyMessages.module.css"
...
const CompanyMesssages = () => {
    ...
    useEffect(() => {
        const initializeMessaging = async () => {
            try {
                ...
                const UserData = {
                    type: "company",
                    id: JSON.parse(localStorage.getItem("user")).Company_id
                ...
                const initialContactsProfiles = conversations.map(conversation => {
                    ...
                    return {
                        ...
                        'id': profile.User_id,
                        'ProfileImg': profile.Photo || ProfileImg,
                        'Name': profile.FirstName + " " + profile.LastName,
                        'CurrentRole': profile.Status || "JobSeeker",
                        'LastMessageContent': LastMessage ? LastMessage.Content : `Start Your Conversation with ${profile.FirstName}`,
    ...
    useEffect(() => {
        ...
        socket.on("receive_message", (message) => {
            ...
            const isSender = socket.user && socket.user.type === "company";
                ...
                <div className={`${styles.MessagePage} ${mobileView === 'list' ? styles.showList : mobileView === 'chat' ? styles.showChat : ''}`}>
                    ...
                    <div className={styles.SecondPart}>
                        <div className={styles.ChatNav}>
                            ...
                            <img src={settings} className={styles.SettingsImg} alt="Settings icon" />
                        </div>
...
export default CompanyMesssages
